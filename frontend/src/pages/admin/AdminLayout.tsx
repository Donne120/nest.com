...
import {
  ...
  LogOut, Bell, ArrowUpRight, ChevronRight, Video, Users
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Topbar */}
        <header className="h-16 bg-white border-b border-gray-200/80 flex items-center px-6 gap-4 flex-shrink-0 z-10">
          {/* Page breadcrumb */}
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {notifOpen && (
                <div className="absolute right-0 top-12 w-80 bg-white border border-gray-200 rounded-xl shadow-modal z-50 overflow-hidden animate-fade-in">
